											...
											<div id="step-1">
												...
												<div class="form-group">
													...
													<div class="col-sm-7">
														...
														<input type="text" autocomplete="off" placeholder="Digita alcune lettere del nome" name="cerca_anagrafica_input" id="cerca_anagrafica_ras_input" class="form-control">
														<div class="risultato_ricerca_anagrafica"></div>
														<input type="hidden" name="id_anagrafica" id="id_anagrafica">
											...
											<div id="step-3">
												...
												<div class="form-group">
													...
													<select multiple="multiple" id="form-field-select-4" class="form-control search-select">
														<?php foreach($motivi_visita as $motivo_visita) { ?>
															<option value="<?php echo $motivo_visita->motivi_id; ?>"><?php echo $motivo_visita->motivi_descrizione; ?></option>
														<?php } ?>
													</select>
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="col-sm-7 input-group">
														<input name="data_visita" id="data_visita" type="text" data-date-format="dd-mm-yyyy" data-date-viewmode="years" class="form-control date-picker">
												...
												<div class="form-group">
													...
													<div class="col-sm-7">
														<textarea name="ras_note" id="ras_note" class="form-control"></textarea>
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="col-sm-2 col-sm-offset-3">
														...
														<button id="bottone_fine_wizard" class="btn btn-success finish-step btn-block" disabled="disabled">
